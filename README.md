...
They fraudulently mislead users in many ways, including promoting overloaded and confusing meanings of decentralized and open source and currency. They use a lot of public blockchain tech and APIs, open source project code produced by companies such as Google, and content delivery and security (for themselves, not their victims) services such as Cloudflare, to perpetrate financial fraud in the open.  BitClout has promoted itself as "open source" since launch, when in fact all of its core code remains closed source to this day (the explorer and the "desktop app" available on GitHub are peripheral).
